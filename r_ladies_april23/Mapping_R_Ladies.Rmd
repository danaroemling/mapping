...
If we wanted to add cities to this, because we're interested in looking at a city level population, we can do this by using geom_point. Let's first load some data to do this. The data here is a tiny portion of the data used by Hovy & Purschke in their [2018 paper](https://aclanthology.org/D18-1469/).
